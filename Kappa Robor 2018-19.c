#pragma config(Motor,  port2,           Left,          tmotorNone, openLoop)
#pragma config(Motor,  port3,           Right,         tmotorVex393_MC29, openLoop)
#pragma config(Motor,  port4,           Claw,          tmotorVex393_MC29, openLoop)
#pragma config(Motor,  port5,           Bar,           tmotorNone, openLoop)
#pragma config(Motor,  port6,           LiftL,         tmotorNone, openLoop)
#pragma config(Motor,  port7,           LiftR,         tmotorNone, openLoop)
